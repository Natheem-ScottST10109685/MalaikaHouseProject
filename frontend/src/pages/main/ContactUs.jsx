...
export default function ContactUs() {
  ...
  const [openFaq, setOpenFaq] = useState(null); // index of open FAQ or null
  const observerRef = useRef(null);

  useEffect(() => {
    // reveal-on-scroll (same as other public pages)
    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <section className="py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="card reveal text-center min-h-[360px]">
            ...
            <div className="card reveal text-center min-h-[360px]">
              ...
              <a
                href="mailto:info@malaikahouse.co.za"
                className="mt-6 inline-block rounded-full bg-indigo-600 px-4 py-2 font-semibold text-white hover:bg-indigo-700"
              >
                Send Email
              </a>
            ...
            <div className="card reveal text-center min-h-[360px]">
              ...
              <span className="mt-6 inline-block rounded-full bg-slate-100 px-4 py-2 text-slate-700">FAX: +27 123 456 790</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mx-auto mt-8 max-w-3xl">
            <form onSubmit={handleSubmit} className="card reveal space-y-6">
      ...
      <section className="bg-slate-50 py-12">
        <div className="max-w-6xl mx-auto grid gap-6 px-4 md:grid-cols-2">
          ...
          <div className="card reveal flex items-center justify-center">
            <div className="text-center">
